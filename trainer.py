...
class SegmentationTrainer:
    def __init__(
        ...
        self._loss = smp_utils.losses.BCEWithLogitsLoss()
        self._metrics = [
    ...
    def start_training(self):
        ...
        for i in range(epoch, epoch + self.epochs_count):
            ...
            writer.add_scalar('Loss/train', train_logs['bce_with_logits_loss'], i)
            ...
            if not self.use_only_add_val:  # если в списке есть основной val набор считаем iou по нему
                ...
                writer.add_scalar(self.valid_loader['name'] + ' loss', valid_logs['bce_with_logits_loss'], i)
            ...
            if self.valid_loader_list is not None:  # Считаем mean_val_iou по нескольким наборам
                ...
                if validate_now:
                    for loader in self.valid_loader_list:
                        ...
                        writer.add_scalar(loader['name'] + ' loss', valid_logs['bce_with_logits_loss'], i)
